...
if (isset($_POST["submit"])) {
  $sql_2 = "UPDATE tb_student SET student_code = '".$_POST['student_code']."', student_prefix = '".$_POST['student_prefix']."', student_name = '".$_POST['student_name']."',
  student_surname = '".$_POST['student_surname']."', student_branch = '".$_POST['student_branch']."' WHERE student_id = '".$id."'";
